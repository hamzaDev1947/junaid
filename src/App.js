  ...
  return (
    <div className="relative bg-gradient-to-br from-[#061a2c] to-[#092b30] min-h-screen text-white px-6 py-4">
      ...
      <nav className="w-full max-w-[1200px] mx-auto flex items-center justify-between px-6 py-6">
        ...
        <div className="flex items-center gap-[30px] px-4 py-2 bg-white/5 border border-white/10 rounded-[10px] backdrop-blur-[50px]">
        ...
        {/* Right: CTA Button */}
        <div>
          <button className="bg-gradient-to-r from-[#3CB55A] to-[#0C8B4F] text-white text-sm font-medium px-6 py-3 rounded-[14px] flex items-center gap-1">
            Get Started →
          </button>
        </div>
      </nav>
      ...
      <div className="text-center mt-24">
        <h1 className="font-inter max-w-[698px] mt-[-40px] w-full mx-auto text-center text-[44px] leading-[61px] px-4 py-10 rounded-md ">
          VeritGuard: 24/7 Managed IT for <br />
          Tax & Accounting Firms
        </h1>
        <p className="text-green-400 font-inter text-[18px] leading-[100%] mt-[-20px] mb-6 w-[295px] mx-auto text-center">
        ...
        <div className="mt-10">
          ...
          <div className="w-[474px] h-[54px] flex items-center justify-center gap-[30px] relative mx-auto">
            <button className="w-[243px] h-[54px] px-[40px] py-[15px] rounded-[14px] bg-gradient-to-r from-[#3CB55A] to-[#0C8B4F] text-white font-inter text-[18px] leading-[100%] cursor-pointer">
              Let’s Get Started
            </button>
            <div className="w-[38px] h-[1px] rotate-90 border border-white opacity-20"></div>
            <button className="w-[171px] h-[22px] flex items-center justify-center text-white font-inter text-[18px] leading-[100%] whitespace-nowrap">
              Schedule A Meeting
            </button>
          </div>
        </div>
